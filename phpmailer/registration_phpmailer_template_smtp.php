...
try {
    ...
    $mail->setFrom('info@limmo.com', 'Message from Limmo');                    // Email Address and Name FROM
    $mail->addAddress('jhon@limmo.com', 'Jhon Doe');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@limmo.com', 'Message from Limmo');              // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Message from Limmo';                                     // Email Subject

    //The email body message
    $message = "<strong>Details</strong><br />";
    $message .= "Address: " . $_POST['useraddress'] . "<br />";
